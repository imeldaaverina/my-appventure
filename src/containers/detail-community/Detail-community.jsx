...
const DetailCommunityContainer = ({ hideFollowButton, isFollowed, isFollowedCommunity }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios({
                url: 'https://api-myappventure.herokuapp.com/api/komunitas/detailkomunitas',
                method: 'get',
                params: {
                    idKomunitas: id,
                }
    ...
    const fetchDatas = async () => {
        ...
        try {
            const response = await axios({
                url: `https://api-myappventure.herokuapp.com/api/post/postingankomunitas/list`,
                method: 'get',
                params: {
                    page: 0,
                    size: 30,
            ...
            <DetailCommunityLayout>
                <section>
                    <div className="max-w-md mx-auto h-full px-2 font-Poppins">
                        ...
                        {data && (
                            <div className="flex justify-end sticky z-50 top-24 right-10 mr-10 mt-10">
                                {
                                    isFollowedCommunity = listFollowingCommunity.includes(data.data.id) ?
                                        <div>
