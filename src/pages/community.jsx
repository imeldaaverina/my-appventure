...
//     NamaKomunitas: Yup.string().required("diperlukan NamaKomunitas").min(3, "NamaKomunitas gunakan 3-15 karakter").max(15, "NamaKomunitas gunakan 3-15 karakter"),
          ...
          <form className="w-full rounded-xl pr-5 pl-1 p-2 pt-7 pb-4" onSubmit={handleSubmit}>
              ...
              <div className="font-normal text-sm mb-1 flex justify-between">
                    ...
                    {getIn(touched, "nama") && getIn(errors, "nama") && ( 
                        <div className="flex items-center justify-start text-xs text-white font-light" data-testid="error-nama"> 
