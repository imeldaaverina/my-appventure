...
//   const postChallengeData = 'besok minggu saya akan pergi berkemah dengan teman - teman saya. Saya berkemah di gunung bromo! Saya sangat tidak sabar!';
  
  return (
      <main className='m-auto flex flex-row justify-center font-Poppins'>
          <div className='text-[#186F79] text-base'>#Paling Populer</div>
      </main>
